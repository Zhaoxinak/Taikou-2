...
spec = {
    ...
    "fields": {
        ...
        "0x28": "→ entity+0x1c（玩法名开放；関係噂档在 0x5197b0 槽+0x1c · 续249）",
        "0x29-0x2a": "父/养父武将索引 u16（0xFFFF=無）→ entity+0x1d · 续204/249",
        "0x2b": "出身地インデックス → entity+0x1f → 0x50bf48 → 国 · 续249",
        "0x2c": "体力上限 → entity+0x20 · 续134/248",
        "0x2d": "体力现役（初值≡上限）→ entity+0x21 · 续134/248",
        "0x2e": "体力消耗 → entity+0x22 · 续134/248",
        "0x2f": "野心（恒 50）→ entity+0x23",
