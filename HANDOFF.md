...
> **非图像结构/数据层：已清零（续253）**。仅图像豁免档不动。

1. （可选增强）存档局面下 dump 全 20 条 S13 記録快照——属局面态，非漏破 LUT。
2. 图像豁免：GRP / PK8 / 纯像素 LZW（明确不碰）。

> ~~`0x518588` / 城种 bit3·4 / `@28` / 评价词阈值 / S7 / SFX15·36 / 出身地 / 父u16 / 関係~~ → **续248–253 已闭或结论性负结果**。
